...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="margin-top:6%">
        <h2 style="color:black;text-align:center">Bus and Route Details</h2>
        <asp:GridView ID="gdBusDetails" runat="server" EmptyDataText="No Record Found...." AutoGenerateColumns="False" AllowPaging="true" PageSize="20" CssClass="table table-hover table-bordered"
                    Width="100%" Font-Size="12" OnRowDataBound="gdBusDetails_RowDataBound" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" ForeColor="Black">
                    <Columns>
