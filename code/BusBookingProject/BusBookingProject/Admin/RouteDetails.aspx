...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="margin-top: 8%">
         <asp:LinkButton  ID="LinkButton1" runat="server" PostBackUrl="~/Admin/Delete.aspx" >Delete Any Route</asp:LinkButton>
         <br />
             <asp:LinkButton  ID="LinkButton2" runat="server" PostBackUrl="~/Admin/BoardingPoints.aspx"  >View Bording Points</asp:LinkButton>
